...
static const struct bt_conn_auth_cb *get_auth_cb(struct bt_smp *smp)
{
...
{
	const struct bt_conn_auth_cb *bt_auth_cb = get_auth_cb(smp);
...
int bt_smp_auth_cb_register(struct bt_conn *conn, const struct bt_conn_auth_cb *cb)
{
	struct bt_smp *smp;
